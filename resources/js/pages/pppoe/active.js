window.addEventListener("load", function () {
    let selected = [];
    const table = new HSDataTable("#table", {
        pageLength: 10,
        pagingOptions: {
    ...
    activeTable.dataTable.on(
        ...
        function () {
            ...
            $("#btn-remove").attr(
                "disabled",
                activeTable.dataTable.rows(".selected").data().length <= 0
            );
        }
    );
