        ...
        <div class="flex items-center gap-2 px-4 md:px-6 py-4">
            ...
            <div class="tooltip [--placement:bottom]">
                ...
                <span class="tooltip-content tooltip-shown:opacity-100 tooltip-shown:visible" role="tooltip">
                    <span class="tooltip-body">Add Secret</span>
                </span>
            </div>
...
document.addEventListener('livewire:navigated', () => {
    table = new HSDataTable("#datatable", {
        ...
        columns: [
            ...
            { data: "service" },
            { data: "profile" },
            { data: "local-address" , defaultContent: ''},
            { data: "remote-address", defaultContent: '' },
            {
                data: "",
    ...
    $("#content").on("click", ".btn-add", function () {
        ...
        form.find('input[name="item.service"]').val('pppoe');
    ...
    $("#content").on("click", ".btn-edit", function () {
        ...
        form.find('input[name="item.local_address"]').val(data["local-address"]);
        form.find('input[name="item.remote_address"]').val(data["remote-address"]);
        form.find('select[name="item.disabled"]').val( data.disabled === 'true' ? 'yes' : 'no');
