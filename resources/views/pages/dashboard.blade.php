...
<div class="flex flex-1 overflow-y-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm px-4 md:px-6 pb-4 md:pb-6">
            ...
            <div class="card-body">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <span class="min-md:text-2xl font-semibold">{{$router->currency}}</span>
    ...
    <div class="card">
        <div class="card-header flex items-center gap-2 pb-2">
            ...
            <x-form.select name="interface" label="" placeholder="Interface" url="/get/interface"/>
        </div>
    ...
    <div class="md:col-span-1 grid grid-cols-subgrid gap-4">
    <div class="card">
            <div class="card-header flex items-center gap-2 pb-1">
