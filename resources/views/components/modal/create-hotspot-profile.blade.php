<div id="form-hotspot-profile-modal" class="overlay modal modal-middle overlay-open:opacity-100 overlay-open:duration-300 hidden [--overlay-backdrop:false] bg-black/50" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-dialog-sm overlay-open:opacity-100 overlay-open:duration-300">
        <div class="modal-content">
            <form id="form-hotspot-profile" action="/hotspot/profiles/add" method="post">
                @csrf
                <div class="modal-header border-b border-base-content/10 pb-0 pt-2 items-center">
                    <h3 class="font-semibold">Add Profile</h3>
                ...
                <div class="modal-body overflow-visible pt-3">
                    ...
                    <div id="general" role="tabpanel" aria-labelledby="tab-general">
                        <x-form.input type="text" name="id" placeholder="0" label="" class="hidden"/>
                        <x-form.input type="text" name="name" placeholder="Profile Name" label="Name" class="mb-3"/>
                        <div class="mb-3">
                        ...
                        <x-form.input type="number" name="sharedusers" placeholder="1" label="Shared Users" class="mb-3"/>
                        <x-form.input type="text" name="ratelimit" placeholder="1M/3M" label="Rate Limit" class="mb-3"/>
                        <div class="mb-3">
                    ...
                    <div class="hidden" id="detail" role="tabpanel" aria-labelledby="tab-detail">
                        <div class="flex grid grid-cols-2 gap-3 mb-3">
                            <div>
                            ...
                            <x-form.input type="text" name="validity" placeholder="1d" label="Validity"/>
                        </div>
                        <x-form.input type="number" name="price" placeholder="0" label="Price" class="mb-3"/>
                        <x-form.input type="number" name="sprice" placeholder="0" label="Selling Price" class="mb-3"/>
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-soft" data-overlay="#form-hotspot-profile-modal">Cancel</button>
