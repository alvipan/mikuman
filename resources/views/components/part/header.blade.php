<header class="sticky top-0 z-50 w-full max-md:shadow">
    <div class="container bg-base-100 mx-auto flex gap-2 h-16 max-w-screen-2xl items-center px-4 md:px-8">
        <button type="button" class="btn btn-sm btn-text btn-outline btn-square sm:hidden me-2" aria-label="Menu" aria-haspopup="dialog" aria-expanded="false" aria-controls="sidenav" data-overlay="#sidenav">
            <span class="icon-[tabler--menu-2] size-5"></span>
        </button>
        <a href="/" class="flex items-center gap-3 text-xl font-semibold">
            <span class="icon-[tabler--comet] text-primary size-8"></span>
            {{config('app.name')}}
        </a>
        <span class="text-sm text-base-content/60 me-auto">{{'v'.config('app.version')}}</span>
        <div class="flex gap-2 items-center">
            <div class="flex items-center max-sm:hidden gap-2">
            ...
            <button type="button" class="btn btn-primary btn-sm" aria-haspopup="dialog" aria-expanded="false" aria-controls="overlay-setting" data-overlay="#overlay-setting">
                Settings
            </button>
        </div>
    </div>
